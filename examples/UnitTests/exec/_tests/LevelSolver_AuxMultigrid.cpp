...
#include "LevelSolver_Multigrid.H"
#include "func.H"
...
int main(int argc, char** argv)
{
    ...
    for (int nn = 0; nn < numIter; nn++)
    {
        ...
        // solver
        LevelSolver_Multigrid<BoxOp_Laplace, double> solver(layout, numLevels, dx);
        ...
        LevelBoxData<double, OP::numAux()>   RhoInv(layout, OP::auxGhost());

...
int main(int argc, char** argv)
{
    ...
    // test code here
    LevelBoxData<double, 3> baseData(crseLayout, Point::Ones());
    baseData.setVal(42);
    LevelBoxData<double, 2> sliceData(baseData, 1);
    h5.writeLevel(dx, baseData, "BASE_0");
    h5.writeLevel(dx, sliceData, "SLICE_0");
    sliceData.setVal(17);
    h5.writeLevel(dx, baseData, "BASE_1");
    h5.writeLevel(dx, sliceData, "SLICE_1");

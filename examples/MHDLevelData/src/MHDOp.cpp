            ...
            bool a_callBCs)
	{
		...
		for (int d = 0; d < DIM; d++)
		{
			...
			Vector del3_W_max = forall<double,NUMCOMPS>( del3_W_max_calc, del3_W_behind, 
														 del3_W, del3_W_ahead, del3_W_ahead2);												 
			Vector W_ave_low_ahead_limited = forall<double,NUMCOMPS>( limiter_low_calc, W_ave_low_ahead, del_W_f_m, del_W_f_p, W_ave, W_ave_ahead2, W_ave_behind2, rho_i, del3_W_max, del3_W_min);															  
			Vector W_ave_high_limited = forall<double,NUMCOMPS>( limiter_high_calc, W_ave_high, del_W_f_m, del_W_f_p, W_ave, W_ave_ahead2, W_ave_behind2, rho_i, del3_W_max, del3_W_min);	
			//Vector limiter_check = forall<double,NUMCOMPS>(limiter_check_calc, del_W_f_m, del_W_f_p, W_ave, W_ave_ahead2, W_ave_behind2, rho_i, del3_W_max, del3_W_min);		
			// Slope flattening starts here
			Vector W_ave_low_ahead_lim_flat = forall<double,NUMCOMPS>(Flat_calc, W_ave_low_ahead_limited, W_ave, eta);
			Vector W_ave_high_lim_flat = forall<double,NUMCOMPS>(Flat_calc, W_ave_high_limited, W_ave, eta);

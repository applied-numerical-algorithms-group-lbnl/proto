// 'euler_step' code generated by 'edavis' at 07/17/2019 12:08:13
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_bar(c,z,y,x) array4[offset4((c),(z)+4,(y)+4,(x)+4,(67+4+1),(67+4+1),(67+4+1))]
//#define u(c,z,y,x) u[(c)]
#define u(c,z,y,x) array3[(c)]
//#define W(c,z,y,x) W[offset4((c),(z)+3,(y)+3,(x)+3,(66+3+1),(66+3+1),(66+3+1))]
#define W(c,z,y,x) array1[offset4((c),(z)+3,(y)+3,(x)+3,(66+3+1),(66+3+1),(66+3+1))]
//#define umax(z,y,x) umax
#define umax(z,y,x) scalar0
//#define W_ave(c,z,y,x) W_ave[offset3((z)+3,(y)+3,(x)+3,(66+3+1),(66+3+1))]
#define W_ave(c,z,y,x) array8[offset3((z)+3,(y)+3,(x)+3,(66+3+1),(66+3+1))]
//#define W_aveL_d1(c,z,y,x) W_aveL_d1[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(65+1))]
#define W_aveL_d1(c,z,y,x) array7[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(65+1))]
//#define W_aveH_d1(c,z,y,x) W_aveH_d1[offset4((c),(z)+3,(y)+3,(x)+1,(66+3+1),(66+3+1),(64+1+1))]
#define W_aveH_d1(c,z,y,x) array6[offset4((c),(z)+3,(y)+3,(x)+1,(66+3+1),(66+3+1),(64+1+1))]
//#define W_aveL_d2(c,z,y,x) W_aveL_d2[offset4((c),(z)+3,(y),(x)+3,(66+3+1),(65+1),(66+3+1))]
#define W_aveL_d2(c,z,y,x) array5[offset4((c),(z)+3,(y),(x)+3,(66+3+1),(65+1),(66+3+1))]
//#define W_aveH_d2(c,z,y,x) W_aveH_d2[offset4((c),(z)+3,(y)+1,(x)+3,(66+3+1),(64+1+1),(66+3+1))]
#define W_aveH_d2(c,z,y,x) array9[offset4((c),(z)+3,(y)+1,(x)+3,(66+3+1),(64+1+1),(66+3+1))]
//#define W_aveL_d3(c,z,y,x) W_aveL_d3[offset4((c),(z),(y)+3,(x)+3,(65+1),(66+3+1),(66+3+1))]
#define W_aveL_d3(c,z,y,x) array3[offset4((c),(z),(y)+3,(x)+3,(65+1),(66+3+1),(66+3+1))]
//#define W_aveH_d3(c,z,y,x) W_aveH_d3[offset4((c),(z)+1,(y)+3,(x)+3,(64+1+1),(66+3+1),(66+3+1))]
#define W_aveH_d3(c,z,y,x) array10[offset4((c),(z)+1,(y)+3,(x)+3,(64+1+1),(66+3+1),(66+3+1))]
//#define W_ave_f_d1(c,z,y,x) W_ave_f_d1[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(64+1))]
#define W_ave_f_d1(c,z,y,x) array1[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(64+1))]
//#define F_bar_f_d1(c,z,y,x) F_bar_f_d1[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(64+1))]
#define F_bar_f_d1(c,z,y,x) array3[offset4((c),(z)+3,(y)+3,(x),(66+3+1),(66+3+1),(64+1))]
//#define W_f_d1(c,z,y,x) W_f_d1[(c)]
#define W_f_d1(c,z,y,x) array4[(c)]
//#define F_ave_f_d1(c,z,y,x) F_ave_f_d1[offset4((c),(z)+2,(y)+2,(x),(65+2+1),(65+2+1),(64+1))]
#define F_ave_f_d1(c,z,y,x) array1[offset4((c),(z)+2,(y)+2,(x),(65+2+1),(65+2+1),(64+1))]
//#define F_lap_f_d1(c,z,y,x) F_lap_f_d1
#define F_lap_f_d1(c,z,y,x) scalar2
...
#define W_ave_f_d2(c,z,y,x) array1[offset4((c),(z)+3,(y),(x)+3,(66+3+1),(64+1),(66+3+1))]
//#define F_bar_f_d2(c,z,y,x) F_bar_f_d2[offset4((c),(z)+3,(y),(x)+3,(66+3+1),(64+1),(66+3+1))]
#define F_bar_f_d2(c,z,y,x) array3[offset4((c),(z)+3,(y),(x)+3,(66+3+1),(64+1),(66+3+1))]
//#define W_f_d2(c,z,y,x) W_f_d2[(c)]
#define W_f_d2(c,z,y,x) array4[(c)]
//#define F_ave_f_d2(c,z,y,x) F_ave_f_d2[offset4((c),(z)+2,(y),(x)+2,(65+2+1),(64+1),(65+2+1))]
#define F_ave_f_d2(c,z,y,x) array1[offset4((c),(z)+2,(y),(x)+2,(65+2+1),(64+1),(65+2+1))]
//#define F_lap_f_d2(c,z,y,x) F_lap_f_d2
#define F_lap_f_d2(c,z,y,x) scalar2
...
#define W_ave_f_d3(c,z,y,x) array1[offset4((c),(z),(y)+3,(x)+3,(64+1),(66+3+1),(66+3+1))]
//#define F_bar_f_d3(c,z,y,x) F_bar_f_d3[offset4((c),(z),(y)+3,(x)+3,(64+1),(66+3+1),(66+3+1))]
#define F_bar_f_d3(c,z,y,x) array3[offset4((c),(z),(y)+3,(x)+3,(64+1),(66+3+1),(66+3+1))]
//#define W_f_d3(c,z,y,x) W_f_d3[(c)]
#define W_f_d3(c,z,y,x) array4[(c)]
//#define F_ave_f_d3(c,z,y,x) F_ave_f_d3[offset4((c),(z),(y)+2,(x)+2,(64+1),(65+2+1),(65+2+1))]
#define F_ave_f_d3(c,z,y,x) array1[offset4((c),(z),(y)+2,(x)+2,(64+1),(65+2+1),(65+2+1))]
//#define F_lap_f_d3(c,z,y,x) F_lap_f_d3
#define F_lap_f_d3(c,z,y,x) scalar2
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double scalar0;
    double* array1 = (double*) malloc(C*(N+6)*(N+6)*(N+6)*sizeof(double));
    double scalar2;
    double* array3 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double* array4 = (double*) malloc(C*(N+8)*(N+8)*(N+8)*sizeof(double));
    double* array5 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double* array6 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double* array7 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double* array8 = (double*) malloc((N+6)*(N+6)*(N+6)*sizeof(double));
    double* array9 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double* array10 = (double*) malloc(C*(N+2)*(N+6)*(N+6)*sizeof(double));
    double retval;      // scalar11 (return values get to keep their names)

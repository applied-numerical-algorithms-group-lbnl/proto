// 'euler_step' code generated by 'edavis' at 06/26/2019 11:09:04
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_ave(c,y,x) W_ave[offset2((y)+3,(x)+3,(66+3+1))]
...
inline double euler_step(const double* U, double* rhs) {
    int t1,t2,t3,t4,t5;
    double* W_bar = (double*) malloc(((4)*(67+4+1))*(67+4+1)*sizeof(double));
    double* u = (double*) malloc((4)*sizeof(double));
    double* W = (double*) malloc(((4)*(66+3+1))*(66+3+1)*sizeof(double));
    double umax;
    double retval;
    double* W_ave = (double*) malloc(((66+3+1))*(66+3+1)*sizeof(double));
    double* W_aveL_d1 = (double*) malloc(((4)*(66+3+1))*(65+1)*sizeof(double));
    double* W_aveH_d1 = (double*) malloc(((4)*(66+3+1))*(64+1+1)*sizeof(double));
    double* W_ave_f_d1 = (double*) malloc(((4)*(66+3+1))*(64+1)*sizeof(double));
    double* F_bar_f_d1 = (double*) malloc(((4)*(66+3+1))*(64+1)*sizeof(double));
    double* W_f_d1 = (double*) malloc((4)*sizeof(double));
    double* F_ave_f_d1 = (double*) malloc(((4)*(65+2+1))*(64+1)*sizeof(double));
    double F_lap_f_d1;
    double F_div_f_d1;
    double* W_aveL_d2 = (double*) malloc(((4)*(65+1))*(66+3+1)*sizeof(double));
    double* W_aveH_d2 = (double*) malloc(((4)*(64+1+1))*(66+3+1)*sizeof(double));
    double* W_ave_f_d2 = (double*) malloc(((4)*(64+1))*(66+3+1)*sizeof(double));
    double* F_bar_f_d2 = (double*) malloc(((4)*(64+1))*(66+3+1)*sizeof(double));
    double* W_f_d2 = (double*) malloc((4)*sizeof(double));
    double* F_ave_f_d2 = (double*) malloc(((4)*(64+1))*(65+2+1)*sizeof(double));
    double F_lap_f_d2;
    double F_div_f_d2;
...
for(t1 = -4; t1 <= 67; t1++) {
  for(t2 = -4; t2 <= 67; t2++) {
    s0(t1,t2);
    if (t1 >= -3 && t2 >= -3 && t2 <= 66 && t1 <= 66) {
      for(t4 = 0; t4 <= 3; t4++) {
        s1(t4,t1,t2);
      }
      s2(t1,t2);
      if (t1 >= 0 && t1 <= 63 && t2 <= 63 && t2 >= 0) {
        s3(t1,t2);
        s4(t1,t2);
      }
    }

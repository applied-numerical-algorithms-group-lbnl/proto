...
inline double euler_step(const double* U, double* rhs) {
    ...
    //double W[5];
    double* W = (double*) malloc(5*sizeof(double));
    double umax;
    double retval;
...
//    double W_aveH_d1[1024];
    double* W_aveL_d1 = (double*) malloc(1024*sizeof(double));
    double* W_aveH_d1 = (double*) malloc(1024*sizeof(double));
...
//    double W_aveH_d2[1024];
    double* W_aveL_d2 = (double*) malloc(1024*sizeof(double));
    double* W_aveH_d2 = (double*) malloc(1024*sizeof(double));
...
//    double W_aveH_d3[1024];
    double* W_aveL_d3 = (double*) malloc(1024*sizeof(double));
    double* W_aveH_d3 = (double*) malloc(1024*sizeof(double));

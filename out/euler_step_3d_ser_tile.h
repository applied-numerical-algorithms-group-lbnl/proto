// 'euler_step' code generated by 'edavis' at 07/18/2019 09:25:58
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define u(c,z,y,x) u[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define W(c,z,y,x) W[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define umax(z,y,x) umax[offset3((z),(y),(x),(N-1+1),(N-1+1))]
#define W_ave(c,z,y,x) W_ave[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define W_aveL_d1(c,z,y,x) W_aveL_d1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1+1))]
#define W_aveH_d1(c,z,y,x) W_aveH_d1[offset4((c),(z)+3,(y)+3,(x)+1,(N+2+3+1),(N+2+3+1),(N+1+1))]
...
#define W_f_d1(c,z,y,x) W_f_d1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_ave_f_d1(c,z,y,x) F_ave_f_d1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_lap_f_d1(c,z,y,x) F_lap_f_d1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_div_f_d1(c,z,y,x) F_div_f_d1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N-1+1))]
#define rhs(c,z,y,x) rhs[offset4((c),(z),(y),(x),(N-1+1),(N-1+1),(N-1+1))]
#define W_aveL_d2(c,z,y,x) W_aveL_d2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))]
#define W_aveH_d2(c,z,y,x) W_aveH_d2[offset4((c),(z)+3,(y)+1,(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))]
...
#define W_f_d2(c,z,y,x) W_f_d2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_ave_f_d2(c,z,y,x) F_ave_f_d2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_lap_f_d2(c,z,y,x) F_lap_f_d2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_div_f_d2(c,z,y,x) F_div_f_d2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N-1+1),(N+1+2+1))]
#define W_aveL_d3(c,z,y,x) W_aveL_d3[offset4((c),(z),(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
#define W_aveH_d3(c,z,y,x) W_aveH_d3[offset4((c),(z)+1,(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
...
#define W_f_d3(c,z,y,x) W_f_d3[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_ave_f_d3(c,z,y,x) F_ave_f_d3[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_lap_f_d3(c,z,y,x) F_lap_f_d3[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_div_f_d3(c,z,y,x) F_div_f_d3[offset4((c),(z),(y)+2,(x)+2,(N-1+1),(N+1+2+1),(N+1+2+1))]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double* W_bar = (double*) malloc((((C)*(N+3+4+1))*(N+3+4+1))*(N+3+4+1)*sizeof(double));
    double* u = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* umax = (double*) malloc((((N-1+1))*(N-1+1))*(N-1+1)*sizeof(double));
    double retval;
    double* W_ave = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    ...
    double* W_f_d1 = (double*) malloc((((C)*(N+1+2+1))*(N+1+2+1))*(N+1)*sizeof(double));
    double* F_ave_f_d1 = (double*) malloc((((C)*(N+1+2+1))*(N+1+2+1))*(N+1)*sizeof(double));
    double* F_lap_f_d1 = (double*) malloc((((C)*(N+1+2+1))*(N+1+2+1))*(N+1)*sizeof(double));
    double* F_div_f_d1 = (double*) malloc((((C)*(N+1+2+1))*(N+1+2+1))*(N-1+1)*sizeof(double));
    ...
    double* W_f_d2 = (double*) malloc((((C)*(N+1+2+1))*(N+1))*(N+1+2+1)*sizeof(double));
    double* F_ave_f_d2 = (double*) malloc((((C)*(N+1+2+1))*(N+1))*(N+1+2+1)*sizeof(double));
    double* F_lap_f_d2 = (double*) malloc((((C)*(N+1+2+1))*(N+1))*(N+1+2+1)*sizeof(double));
    double* F_div_f_d2 = (double*) malloc((((C)*(N+1+2+1))*(N-1+1))*(N+1+2+1)*sizeof(double));
    ...
    double* W_f_d3 = (double*) malloc((((C)*(N+1))*(N+1+2+1))*(N+1+2+1)*sizeof(double));
    double* F_ave_f_d3 = (double*) malloc((((C)*(N+1))*(N+1+2+1))*(N+1+2+1)*sizeof(double));
    double* F_lap_f_d3 = (double*) malloc((((C)*(N+1))*(N+1+2+1))*(N+1+2+1)*sizeof(double));
    double* F_div_f_d3 = (double*) malloc((((C)*(N-1+1))*(N+1+2+1))*(N+1+2+1)*sizeof(double));
      ...
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(8*t4+7,N+2); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(N+2,8*t6+7); t12++) {
            for(t14 = max(-3,8*t8); t14 <= min(8*t8+7,N+2); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
        }
...
for(t2 = 0; t2 <= floord(N-1,8); t2++) {
  for(t4 = 0; t4 <= floord(N-1,8); t4++) {
    for(t6 = 0; t6 <= floord(N-1,8); t6++) {
      for(t8 = 8*t2; t8 <= min(N-1,8*t2+7); t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,N-1); t10++) {
          for(t12 = 8*t6; t12 <= min(N-1,8*t6+7); t12++) {
            s0(t8,t10,t12);
          }
        }
      }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = 0; t8 <= floord(N+1,8); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(8*t4+7,N+2); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(N+2,8*t6+7); t12++) {
            for(t14 = 8*t8; t14 <= min(8*t8+7,N+1); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
        }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = -1; t8 <= floord(N,8); t8++) {
        for(t10 = max(8*t4,2*t4-1); t10 <= min(N+2,8*t4+7); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(8*t6+7,N+2); t12++) {
      ...
      for(t8 = 0; t8 <= floord(N,8); t8++) {
        for(t10 = max(8*t4,-2); t10 <= min(N+1,8*t4+7); t10++) {
          for(t12 = max(8*t6,-2); t12 <= min(N+1,8*t6+7); t12++) {
            for(t14 = 8*t8; t14 <= min(8*t8+7,N); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
        }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = 0; t4 <= floord(N-1,8); t4++) {
    for(t6 = 0; t6 <= floord(N-1,8); t6++) {
      for(t8 = 0; t8 <= floord(N-1,8); t8++) {
        for(t10 = 8*t4; t10 <= min(N-1,8*t4+7); t10++) {
          for(t12 = 8*t6; t12 <= min(8*t6+7,N-1); t12++) {
            for(t14 = 8*t8; t14 <= min(8*t8+7,N-1); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
  ...
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = 0; t6 <= floord(N+1,8); t6++) {
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(8*t4+7,N+2); t10++) {
          for(t12 = 8*t6; t12 <= min(8*t6+7,N+1); t12++) {
            for(t14 = max(8*t8,2*t8-1); t14 <= min(N+2,8*t8+7); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
        }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = -1; t6 <= floord(N,8); t6++) {
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = max(8*t4,2*t4-1); t10 <= min(N+2,8*t4+7); t10++) {
          for(t12 = max(-1,8*t6); t12 <= min(8*t6+7,N); t12++) {
            for(t14 = max(-3,8*t8); t14 <= min(8*t8+7,N+2); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
  ...
  for(t4 = 0; t4 <= floord(N+1,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = 8*t4; t10 <= min(N+1,8*t4+7); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(N+2,8*t6+7); t12++) {
            for(t14 = max(8*t8,2*t8-1); t14 <= min(8*t8+7,N+2); t14++) {
              s0(t2,t10,t12,t14);
            }
          }
        }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = max(t4,8*t4); t10 <= min(8*t4+7,N); t10++) {
          for(t12 = max(-3,8*t6); t12 <= min(8*t6+7,N+2); t12++) {
            for(t14 = max(-3,8*t8); t14 <= min(8*t8+7,N+2); t14++) {
              s0(t2,t10,t12,t14);
            }

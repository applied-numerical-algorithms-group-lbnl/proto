// 'euler_step' code generated by 'edavis' at 07/22/2019 14:00:32
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_bar(c,z,y,x) array2[offset4((c),(z)+4,(y)+4,(x)+4,(N+3+4+1),(N+3+4+1),(N+3+4+1))]
#define u(c,z,y,x) array1[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define W(c,z,y,x) array0[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define umax(z,y,x) array1[offset3((z),(y),(x),(N-1+1),(N-1+1))]
#define W_ave(c,z,y,x) array1[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define W_aveL_d1(c,z,y,x) array3[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1+1))]
#define W_aveH_d1(c,z,y,x) array0[offset4((c),(z)+3,(y)+3,(x)+1,(N+2+3+1),(N+2+3+1),(N+1+1))]
...
#define W_f_d1(c,z,y,x) array0[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_ave_f_d1(c,z,y,x) array2[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_lap_f_d1(c,z,y,x) array0[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
#define F_div_f_d1(c,z,y,x) array0[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N-1+1))]
#define rhs(c,z,y,x) rhs[offset4((c),(z),(y),(x),(N-1+1),(N-1+1),(N-1+1))]
#define W_aveL_d2(c,z,y,x) array3[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))]
#define W_aveH_d2(c,z,y,x) array0[offset4((c),(z)+3,(y)+1,(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))]
...
#define W_f_d2(c,z,y,x) array0[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_ave_f_d2(c,z,y,x) array2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_lap_f_d2(c,z,y,x) array0[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_div_f_d2(c,z,y,x) array0[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N-1+1),(N+1+2+1))]
#define W_aveL_d3(c,z,y,x) array0[offset4((c),(z),(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
#define W_aveH_d3(c,z,y,x) array2[offset4((c),(z)+1,(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
#define W_ave_f_d3(c,z,y,x) array1[offset4((c),(z),(y)+3,(x)+3,(N+1),(N+2+3+1),(N+2+3+1))]
#define F_bar_f_d3(c,z,y,x) array2[offset4((c),(z),(y)+3,(x)+3,(N+1),(N+2+3+1),(N+2+3+1))]
#define W_f_d3(c,z,y,x) array0[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_ave_f_d3(c,z,y,x) array1[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_lap_f_d3(c,z,y,x) array0[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_div_f_d3(c,z,y,x) array0[offset4((c),(z),(y)+2,(x)+2,(N-1+1),(N+1+2+1),(N+1+2+1))]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double* array2 = (double*) malloc(1866240*sizeof(double));
    double* array1 = (double*) malloc(1715000*sizeof(double));
    double* array0 = (double*) malloc(1715000*sizeof(double));
    double retval;
    double* array3 = (double*) malloc(1617000*sizeof(double));
...
//#pragma omp parallel for schedule(auto) private(t1,t2,t4,t6,t8,t10,t12)

// 'euler_step' code generated by 'edavis' at 08/05/2019 15:07:33
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define F_ave_f_d2(c,z,y,x) array3[(c)]
              ...
              if (t2 <= 0) {
                ...
                if (t6 <= 2) {
                  ...
                  if (N >= t6-2) {
                    for(t8 = 0; t8 <= C-1; t8++) {
                      s5(t8,t2,t4-3,t6-3);
                      s6(t8,t2-1,t4-3,t6-3);
                      s7(t8,t2-1,t4-3,t6-3);
                    }
                  }
                  else {
                    for(t8 = 0; t8 <= C-1; t8++) {

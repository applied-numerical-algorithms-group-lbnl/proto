// 'euler_step' code generated by 'edavis' at 07/17/2019 17:28:50
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_bar(c,z,y,x) W_bar[offset4((c),(z)+4,(y)+4,(x)+4,(N+3+4+1),(N+3+4+1),(N+3+4+1))&32767]
#define u(c,z,y,x) u[(c)]
#define W(c,z,y,x) W[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))&16383]
#define umax(z,y,x) umax
#define W_ave(c,z,y,x) W_ave[offset3((z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1))&4095]
#define W_aveL_d1(c,z,y,x) W_aveL_d1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1+1))&16383]
#define W_aveH_d1(c,z,y,x) W_aveH_d1[offset4((c),(z)+3,(y)+3,(x)+1,(N+2+3+1),(N+2+3+1),(N+1+1))&16383]
#define W_aveL_d2(c,z,y,x) W_aveL_d2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))&16383]
#define W_aveH_d2(c,z,y,x) W_aveH_d2[offset4((c),(z)+3,(y)+1,(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))&16383]
#define W_aveL_d3(c,z,y,x) W_aveL_d3[offset4((c),(z),(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))&16383]
#define W_aveH_d3(c,z,y,x) W_aveH_d3[offset4((c),(z)+1,(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))&16383]
#define W_ave_f_d1(c,z,y,x) W_ave_f_d1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))&16383]
#define F_bar_f_d1(c,z,y,x) F_bar_f_d1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))&16383]
#define W_f_d1(c,z,y,x) W_f_d1[(c)]
#define F_ave_f_d1(c,z,y,x) F_ave_f_d1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))&8191]
...
#define W_ave_f_d2(c,z,y,x) W_ave_f_d2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))&16383]
#define F_bar_f_d2(c,z,y,x) F_bar_f_d2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))&16383]
#define W_f_d2(c,z,y,x) W_f_d2[(c)]
#define F_ave_f_d2(c,z,y,x) F_ave_f_d2[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))&8191]
#define F_lap_f_d2(c,z,y,x) F_lap_f_d2
#define F_div_f_d2(c,z,y,x) F_div_f_d2
#define W_ave_f_d3(c,z,y,x) W_ave_f_d3[offset4((c),(z),(y)+3,(x)+3,(N+1),(N+2+3+1),(N+2+3+1))&16383]
#define F_bar_f_d3(c,z,y,x) F_bar_f_d3[offset4((c),(z),(y)+3,(x)+3,(N+1),(N+2+3+1),(N+2+3+1))&16383]
#define W_f_d3(c,z,y,x) W_f_d3[(c)]
#define F_ave_f_d3(c,z,y,x) F_ave_f_d3[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))&8191]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    //double* W_bar = (double*) malloc((((C)*(T+3+4+1))*(T+3+4+1))*(T+3+4+1)*sizeof(double));
    double* W_bar = (double*) malloc(32768*sizeof(double));
    double* u = (double*) malloc((C)*sizeof(double));
    //double* W = (double*) malloc((((C)*(T+2+3+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* W = (double*) malloc(16384*sizeof(double));
    double umax;
    double retval;
    //double* W_ave = (double*) malloc((((T+2+3+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* W_ave = (double*) malloc(4096*sizeof(double));
    //double* W_aveL_d1 = (double*) malloc((((C)*(T+2+3+1))*(T+2+3+1))*(T+1+1)*sizeof(double));
    double* W_aveL_d1 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d1 = (double*) malloc((((C)*(T+2+3+1))*(T+2+3+1))*(T+1+1)*sizeof(double));
    double* W_aveH_d1 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d1 = (double*) malloc((((C)*(T+2+3+1))*(T+2+3+1))*(T+1)*sizeof(double));
    double* W_ave_f_d1 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d1 = (double*) malloc((((C)*(T+2+3+1))*(T+2+3+1))*(T+1)*sizeof(double));
    double* F_bar_f_d1 = (double*) malloc(16384*sizeof(double));
    double* W_f_d1 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d1 = (double*) malloc((((C)*(T+1+2+1))*(T+1+2+1))*(T+1)*sizeof(double));
    double* F_ave_f_d1 = (double*) malloc(8192*sizeof(double));
    double F_lap_f_d1;
    double F_div_f_d1;
    //double* W_aveL_d2 = (double*) malloc((((C)*(T+2+3+1))*(T+1+1))*(T+2+3+1)*sizeof(double));
    double* W_aveL_d2 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d2 = (double*) malloc((((C)*(T+2+3+1))*(T+1+1))*(T+2+3+1)*sizeof(double));
    double* W_aveH_d2 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d2 = (double*) malloc((((C)*(T+2+3+1))*(T+1))*(T+2+3+1)*sizeof(double));
    double* W_ave_f_d2 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d2 = (double*) malloc((((C)*(T+2+3+1))*(T+1))*(T+2+3+1)*sizeof(double));
    double* F_bar_f_d2 = (double*) malloc(16384*sizeof(double));
    double* W_f_d2 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d2 = (double*) malloc((((C)*(T+1+2+1))*(T+1))*(T+1+2+1)*sizeof(double));
    double* F_ave_f_d2 = (double*) malloc(8192*sizeof(double));
    double F_lap_f_d2;
    double F_div_f_d2;
    //double* W_aveL_d3 = (double*) malloc((((C)*(T+1+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* W_aveL_d3 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d3 = (double*) malloc((((C)*(T+1+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* W_aveH_d3 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d3 = (double*) malloc((((C)*(T+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* W_ave_f_d3 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d3 = (double*) malloc((((C)*(T+1))*(T+2+3+1))*(T+2+3+1)*sizeof(double));
    double* F_bar_f_d3 = (double*) malloc(16384*sizeof(double));
    double* W_f_d3 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d3 = (double*) malloc((((C)*(T+1))*(T+1+2+1))*(T+1+2+1)*sizeof(double));
    double* F_ave_f_d3 = (double*) malloc(8192*sizeof(double));
    double F_lap_f_d3;
    double F_div_f_d3;
...
for(t2 = -1; t2 <= floord(N+3,8); t2++) {
  for(t4 = -1; t4 <= floord(N+3,8); t4++) {
    for(t6 = -1; t6 <= floord(N+3,8); t6++) {
      for(t8 = max(-4,8*t2); t8 <= min(8*t2+7,N+3); t8++) {
        for(t10 = max(8*t4,-4); t10 <= min(N+3,8*t4+7); t10++) {
          for(t12 = max(-4,8*t6); t12 <= min(8*t6+7,N+3); t12++) {
            s0(t8,t10,t12);
            if (N >= t10-2 && t10 >= -3 && N >= t8-2 && N >= t12-2 && t12 >= -3 && t8 >= -3) {
              for(t14 = 0; t14 <= C-1; t14++) {
                s1(t14,t8,t10,t12);
              }
              s2(t8,t10,t12);
              if (N >= t10+1 && t8 >= 0 && t12 >= 0 && N >= t12+1 && N >= t8+1 && t10 >= 0) {
                s3(t8,t10,t12);
                s4(t8,t10,t12);
              }
            }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = -1; t8 <= floord(N+2,8); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(8*t4+7,N+2); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(N+2,8*t6+7); t12++) {
            if (t12 <= 0) {
              if (t10 <= 0) {
                for(t14 = max(-3,8*t8); t14 <= min(8*t8+7,0); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                }
              }
              else {
                for(t14 = max(-3,5*t8); t14 <= min(8*t8+7,0); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s6(t2,t10-1,t12,t14);
                  s7(t2,t10-2,t12,t14);
              ...
              if (t10 <= 0) {
                ...
                for(t14 = max(5*t8,-3); t14 <= min(8*t8+7,0); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s4(t2,t10,t12-1,t14);
                  s5(t2,t10,t12-2,t14);
            ...
            if (t12 <= 0) {
              if (t10 <= 0) {
                for(t14 = max(8*t8,1); t14 <= min(N+2,8*t8+7); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s2(t2,t10,t12,t14-1);
                  s3(t2,t10,t12,t14-2);
                ...
                for(t14 = max(8*t8,1); t14 <= min(8*t8+7,N+2); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s2(t2,t10,t12,t14-1);
                  s3(t2,t10,t12,t14-2);
              ...
              if (t10 <= 0) {
                for(t14 = max(1,8*t8); t14 <= min(8*t8+7,N+2); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s2(t2,t10,t12,t14-1);
                  s3(t2,t10,t12,t14-2);
  ...
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = 0; t6 <= floord(N,8); t6++) {
      for(t8 = max(8*t2,2*t2-1); t8 <= min(N+2,8*t2+7); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(N+2,8*t4+7); t10++) {
          for(t12 = 8*t6; t12 <= min(8*t6+7,N); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= C-1; t14++) {
              s2(t14,t8,t10,t12);
...
for(t2 = -1; t2 <= floord(N+1,8); t2++) {
  for(t4 = -1; t4 <= floord(N+1,8); t4++) {
    for(t6 = 0; t6 <= floord(N,8); t6++) {
      for(t8 = max(8*t2,-2); t8 <= min(N+1,8*t2+7); t8++) {
        for(t10 = max(-2,8*t4); t10 <= min(8*t4+7,N+1); t10++) {
          for(t12 = 8*t6; t12 <= min(8*t6+7,N); t12++) {
            for(t14 = 0; t14 <= C-1; t14++) {
              s0(t14,t8,t10,t12);
            }
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+1,8); t4++) {
    for(t6 = -1; t6 <= floord(N+1,8); t6++) {
      for(t8 = 0; t8 <= floord(N,8); t8++) {
        for(t10 = max(8*t4,-2); t10 <= min(N+1,8*t4+7); t10++) {
          for(t12 = max(8*t6,-2); t12 <= min(N+1,8*t6+7); t12++) {
            if (t8 <= 0) {
              s0(t2,t10,t12,0);
              s1(t2,t10,t12,0);
            }
            if (t4 == -1) {
              for(t14 = max(8*t8,1); t14 <= min(N,8*t8+7); t14++) {
                s0(t2,t10,t12,t14);
                s1(t2,t10,t12,t14);
                s2(t2,t10,t12,t14-1);
              }
            ...
            if (N >= t10+1) {
              if (t10 >= 0) {
                if (t6 == -1) {
                  for(t14 = max(1,8*t8); t14 <= min(N,8*t8+7); t14++) {
                    s0(t2,t10,t12,t14);
                    s1(t2,t10,t12,t14);
                    s2(t2,t10,t12,t14-1);
                  }
            ...
            if (t12 >= N && t10 >= 0) {
              for(t14 = max(1,8*t8); t14 <= min(8*t8+7,N); t14++) {
                s0(t2,t10,t12,t14);
                s1(t2,t10,t12,t14);
                s2(t2,t10,t12,t14-1);
              }
...
for(t2 = -1; t2 <= floord(N+2,8); t2++) {
  for(t4 = 0; t4 <= floord(N,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = max(-3,8*t2); t8 <= min(8*t2+7,N+2); t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,N); t10++) {
          for(t12 = max(-3,8*t6); t12 <= min(8*t6+7,N+2); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= C-1; t14++) {
              s2(t14,t8,t10,t12);
...
for(t2 = -1; t2 <= floord(N+1,8); t2++) {
  for(t4 = 0; t4 <= floord(N,8); t4++) {
    for(t6 = -1; t6 <= floord(N+1,8); t6++) {
      for(t8 = max(-2,8*t2); t8 <= min(8*t2+7,N+1); t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,N); t10++) {
          for(t12 = max(-2,8*t6); t12 <= min(8*t6+7,N+1); t12++) {
            for(t14 = 0; t14 <= C-1; t14++) {
              s0(t14,t8,t10,t12);
            }
            s1(t8,t10,t12);
...
for(t2 = 0; t2 <= C-1; t2++) {
  for(t4 = -1; t4 <= floord(N+1,8); t4++) {
    for(t6 = 0; t6 <= floord(N,8); t6++) {
      for(t8 = -1; t8 <= floord(N+1,8); t8++) {
        for(t10 = max(8*t4,-2); t10 <= min(N+1,8*t4+7); t10++) {
          for(t12 = 8*t6; t12 <= min(8*t6+7,N); t12++) {
            if (t12 <= 0) {
              for(t14 = max(-2,8*t8); t14 <= min(8*t8+7,N+1); t14++) {
                s0(t2,t10,t12,t14);
                s1(t2,t10,t12,t14);
              }
            }
              ...
              if (N >= t10+1) {
                if (t10 >= 0) {
                  ...
                  for(t14 = 8*t8; t14 <= min(N+1,8*t8+7); t14++) {
                    if (t14 >= 0) {
                      s0(t2,t10,t12,t14);
                      s1(t2,t10,t12,t14);
                      s2(t2,t10,t12-1,t14);
                ...
                for(t14 = max(8*t8,-2); t14 <= min(N+1,8*t8+7); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s2(t2,t10,t12-1,t14);
                }
  ...
  for(t4 = -1; t4 <= floord(N+2,8); t4++) {
    for(t6 = -1; t6 <= floord(N+2,8); t6++) {
      for(t8 = 8*t2; t8 <= min(N,8*t2+7); t8++) {
        for(t10 = max(8*t4,2*t4-1); t10 <= min(N+2,8*t4+7); t10++) {
          for(t12 = max(8*t6,2*t6-1); t12 <= min(N+2,8*t6+7); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= C-1; t14++) {
            ...
            if (t10 <= 0) {
              if (t4 <= 0) {
                if (N >= t12+1) {
                  ...
                  for(t14 = max(0,8*t8); t14 <= min(8*t8+7,N-1); t14++) {
                    s0(t2,t10,t12,t14);
                    s1(t2,t10,t12,t14);
                    if (t12 >= 0) {
                      s4(t2,t10,t12,t14);
                ...
                for(t14 = max(8*t8,N); t14 <= min(N+1,8*t8+7); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                }
              }
              ...
              if (t6 == -1) {
                for(t14 = max(-2,8*t8); t14 <= min(N+1,8*t8+7); t14++) {
                  s0(t2,t10,t12,t14);
                  s1(t2,t10,t12,t14);
                  s2(t2,t10-1,t12,t14);
                }
              ...
              if (N >= t12+1) {
                if (t12 >= 0) {
                  ...
                  for(t14 = max(0,8*t8); t14 <= min(N-1,8*t8+7); t14++) {
                    s0(t2,t10,t12,t14);
                    s1(t2,t10,t12,t14);
                    s2(t2,t10-1,t12,t14);
                    s3(t2,t10-1,t12,t14);
                  ...
                  for(t14 = max(N,8*t8); t14 <= min(8*t8+7,N+1); t14++) {
                    s0(t2,t10,t12,t14);
                    s1(t2,t10,t12,t14);
                    s2(t2,t10-1,t12,t14);
                  }

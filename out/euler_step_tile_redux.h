...
inline double euler_step(const double* U, double* rhs) {
    ...
    //double* W = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W = (double*) malloc(16384*sizeof(double));
    double umax;
    double retval;
    //double* W_ave = (double*) malloc((((N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W_ave = (double*) malloc(4096*sizeof(double));
    //double* W_aveL_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1+1)*sizeof(double));
    double* W_aveL_d1 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1+1)*sizeof(double));
    double* W_aveH_d1 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1)*sizeof(double));
    double* W_ave_f_d1 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1)*sizeof(double));
    double* F_bar_f_d1 = (double*) malloc(16384*sizeof(double));
    double* W_f_d1 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d1 = (double*) malloc((((C)*(N+1+2+1))*(N+1+2+1))*(N+1)*sizeof(double));
    double* F_ave_f_d1 = (double*) malloc(8192*sizeof(double));
    double F_lap_f_d1;
    double F_div_f_d1;
    //double* W_aveL_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1+1))*(N+2+3+1)*sizeof(double));
    double* W_aveL_d2 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1+1))*(N+2+3+1)*sizeof(double));
    double* W_aveH_d2 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1))*(N+2+3+1)*sizeof(double));
    double* W_ave_f_d2 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1))*(N+2+3+1)*sizeof(double));
    double* F_bar_f_d2 = (double*) malloc(16384*sizeof(double));
    double* W_f_d2 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d2 = (double*) malloc((((C)*(N+1+2+1))*(N+1))*(N+1+2+1)*sizeof(double));
    double* F_ave_f_d2 = (double*) malloc(8192*sizeof(double));
    double F_lap_f_d2;
    double F_div_f_d2;
    //double* W_aveL_d3 = (double*) malloc((((C)*(N+1+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W_aveL_d3 = (double*) malloc(16384*sizeof(double));
    //double* W_aveH_d3 = (double*) malloc((((C)*(N+1+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W_aveH_d3 = (double*) malloc(16384*sizeof(double));
    //double* W_ave_f_d3 = (double*) malloc((((C)*(N+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* W_ave_f_d3 = (double*) malloc(16384*sizeof(double));
    //double* F_bar_f_d3 = (double*) malloc((((C)*(N+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* F_bar_f_d3 = (double*) malloc(16384*sizeof(double));
    double* W_f_d3 = (double*) malloc((C)*sizeof(double));
    //double* F_ave_f_d3 = (double*) malloc((((C)*(N+1))*(N+1+2+1))*(N+1+2+1)*sizeof(double));

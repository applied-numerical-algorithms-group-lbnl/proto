// 'euler_step' code generated by 'edavis' at 08/06/2019 09:40:38
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_ave(c,z,y,x) array0[offset3((z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1))]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    float* __restrict array1 = (float*) malloc(1866240*sizeof(float));
    float* __restrict array2 = (float*) malloc(5*sizeof(float));
    float* __restrict array3 = (float*) malloc(1715000*sizeof(float));
    float* __restrict array0 = (float*) malloc(1592500*sizeof(float));
    double retval;
    float* __restrict array9 = (float*) malloc(1617000*sizeof(float));
    float* __restrict array8 = (float*) malloc(1617000*sizeof(float));
    float* __restrict array7 = (float*) malloc(1617000*sizeof(float));
    float* __restrict array6 = (float*) malloc(1617000*sizeof(float));
    float* __restrict array5 = (float*) malloc(1617000*sizeof(float));
    float* __restrict array4 = (float*) malloc(1617000*sizeof(float));
...
for(t2 = -4; t2 <= N+3; t2++) {
  for(t4 = -4; t4 <= N+3; t4++) {
    ...
    for(t6 = -4; t6 <= N+3; t6++) {
      s0(t2,t4,t6);
      if (t6 >= -3 && t4 >= -3 && N >= t2-2 && N >= t4-2 && t2 >= -3 && N >= t6-2) {
        for(t8 = 0; t8 <= C-1; t8++) {
          s1(t8,t2,t4,t6);
        }
        s2(t2,t4,t6);
        if (t6 >= 0 && N >= t6+1 && t2 >= 0 && N >= t4+1 && N >= t2+1 && t4 >= 0) {
          s3(t2,t4,t6);
          s4(t2,t4,t6);
        }
      }
              ...
              if (t2 <= 0) {
                ...
                if (t6 <= 1) {
                  ...
                  if (N >= t6-1) {
                    for(t8 = 0; t8 <= C-1; t8++) {
                      s5(t8,t2,t4-2,t6-2);
                      s6(t8,t2-1,t4-2,t6-2);
                      s7(t8,t2-1,t4-2,t6-2);
                    }
                  }
                  else {
                    for(t8 = 0; t8 <= C-1; t8++) {

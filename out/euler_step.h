...
#define W_ave(c,z,y,x) array11[tid][offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))&524287]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    for (t1 = 0; t1 < tnum; t1++) {
      ...
      array11[t1] = (double *) malloc(1048576 * sizeof(double));
      array12[t1] = (double *) malloc(16384 * sizeof(double));
      array13[t1] = (double *) malloc(16384 * sizeof(double));
    }

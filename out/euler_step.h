// 'euler_step' code generated by 'edavis' at 08/02/2019 13:14:45
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define u(c,z,y,x) array0[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define W(c,z,y,x) array2[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))]
#define umax(z,y,x) array0[offset3((z),(y),(x),(N-1+1),(N-1+1))]
...
#define W_aveH_d1(c,z,y,x) array2[offset4((c),(z)+3,(y)+3,(x)+1,(N+2+3+1),(N+2+3+1),(N+1+1))]
#define W_ave_f_d1(c,z,y,x) array1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))]
#define F_bar_f_d1(c,z,y,x) array2[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))]
#define W_f_d1(c,z,y,x) array3[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))]
...
#define W_aveH_d2(c,z,y,x) array2[offset4((c),(z)+3,(y)+1,(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))]
#define W_ave_f_d2(c,z,y,x) array1[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))]
#define F_bar_f_d2(c,z,y,x) array2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))]
#define W_f_d2(c,z,y,x) array3[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define F_ave_f_d2(c,z,y,x) array1[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))]
#define W_aveL_d3(c,z,y,x) array2[offset4((c),(z),(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
#define W_aveH_d3(c,z,y,x) array1[offset4((c),(z)+1,(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))]
...
#define W_f_d3(c,z,y,x) array2[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
#define F_ave_f_d3(c,z,y,x) array0[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double retval;
    double* __restrict array3 = (double*) malloc(1617000*sizeof(double));
...
// lap_f_d1
#undef s0
#define s0(c,z,y,x) F_ave_f_d1((c),(z),(y),(x))+=((-0.166667)*F_bar_f_d1((c),(z),(y),(x)))+(0.041667*F_bar_f_d1((c),(z),(y)+1,(x)))+(0.041667*F_bar_f_d1((c),(z),(y)-1,(x)))+(0.041667*F_bar_f_d1((c),(z)+1,(y),(x)))+(0.041667*F_bar_f_d1((c),(z)-1,(y),(x)))
...
// div_f_d1
#undef s0
#define s0(c,z,y,x) rhs((c),(z),(y),(x))+=((-1.000000)*F_ave_f_d1((c),(z),(y),(x)))+(1.000000*F_ave_f_d1((c),(z),(y),(x)+1))
...
// lap_f_d2
#undef s0
#define s0(c,z,y,x) F_ave_f_d2((c),(z),(y),(x))+=((-0.166667)*F_bar_f_d2((c),(z),(y),(x)))+(0.041667*F_bar_f_d2((c),(z),(y),(x)+1))+(0.041667*F_bar_f_d2((c),(z),(y),(x)-1))+(0.041667*F_bar_f_d2((c),(z)+1,(y),(x)))+(0.041667*F_bar_f_d2((c),(z)-1,(y),(x)))
...
// div_f_d2
#undef s0
#define s0(c,z,y,x) rhs((c),(z),(y),(x))+=((-1.000000)*F_ave_f_d2((c),(z),(y),(x)))+(1.000000*F_ave_f_d2((c),(z),(y)+1,(x)))
...
// lap_f_d3
#undef s0
#define s0(c,z,y,x) F_ave_f_d3((c),(z),(y),(x))+=((-0.166667)*F_bar_f_d3((c),(z),(y),(x)))+(0.041667*F_bar_f_d3((c),(z),(y),(x)+1))+(0.041667*F_bar_f_d3((c),(z),(y),(x)-1))+(0.041667*F_bar_f_d3((c),(z),(y)+1,(x)))+(0.041667*F_bar_f_d3((c),(z),(y)-1,(x)))
...
// div_f_d3
#undef s0
#define s0(c,z,y,x) rhs((c),(z),(y),(x))+=((-1.000000)*F_ave_f_d3((c),(z),(y),(x)))+(1.000000*F_ave_f_d3((c),(z)+1,(y),(x)))

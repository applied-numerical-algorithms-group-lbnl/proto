// 'euler_step' code generated by 'edavis' at 08/08/2019 17:51:01
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
//    }
    ...
    double* __restrict W = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* __restrict W_ave = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* __restrict W_aveL_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1+1)*sizeof(double));
    double* __restrict W_aveH_d1 = (double*) malloc((((C)*(N+2+3+1))*(N+2+3+1))*(N+1+1)*sizeof(double));
    ...
    double* __restrict W_aveL_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1+1))*(N+2+3+1)*sizeof(double));
    double* __restrict W_aveH_d2 = (double*) malloc((((C)*(N+2+3+1))*(N+1+1))*(N+2+3+1)*sizeof(double));
    ...
    double* __restrict W_aveL_d3 = (double*) malloc((((C)*(N+1+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
    double* __restrict W_aveH_d3 = (double*) malloc((((C)*(N+1+1))*(N+2+3+1))*(N+2+3+1)*sizeof(double));
...
// consToPrim1+deconvolve+consToPrim2
#undef s0
#define s0(z,y,x) {\

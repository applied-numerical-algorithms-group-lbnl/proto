// 'euler_step' code generated by 'edavis' at 07/22/2019 14:19:03
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_bar(c,z,y,x) array3[offset4((c),(z)+4,(y)+4,(x)+4,(N+3+4+1),(N+3+4+1),(N+3+4+1))&32767]
#define u(c,z,y,x) array5[(c)]
#define W(c,z,y,x) array4[offset4((c),(z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1),(N+2+3+1))&16383]
#define umax(z,y,x) scalar0
#define W_ave(c,z,y,x) array1[offset3((z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1))&8191]
#define W_aveL_d1(c,z,y,x) array11[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1+1))&16383]
#define W_aveH_d1(c,z,y,x) array10[offset4((c),(z)+3,(y)+3,(x)+1,(N+2+3+1),(N+2+3+1),(N+1+1))&16383]
#define W_aveL_d2(c,z,y,x) array9[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))&16383]
#define W_aveH_d2(c,z,y,x) array8[offset4((c),(z)+3,(y)+1,(x)+3,(N+2+3+1),(N+1+1),(N+2+3+1))&16383]
#define W_aveL_d3(c,z,y,x) array7[offset4((c),(z),(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))&16383]
#define W_aveH_d3(c,z,y,x) array6[offset4((c),(z)+1,(y)+3,(x)+3,(N+1+1),(N+2+3+1),(N+2+3+1))&16383]
#define W_ave_f_d1(c,z,y,x) array4[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))&16383]
#define F_bar_f_d1(c,z,y,x) array3[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))&32767]
#define W_f_d1(c,z,y,x) array5[(c)]
#define F_ave_f_d1(c,z,y,x) array1[offset4((c),(z)+2,(y)+2,(x),(N+1+2+1),(N+1+2+1),(N+1))&8191]
...
#define W_ave_f_d2(c,z,y,x) array4[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))&16383]
#define F_bar_f_d2(c,z,y,x) array3[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))&32767]
#define W_f_d2(c,z,y,x) array5[(c)]
#define F_ave_f_d2(c,z,y,x) array1[offset4((c),(z)+2,(y),(x)+2,(N+1+2+1),(N+1),(N+1+2+1))&8191]
#define F_lap_f_d2(c,z,y,x) scalar0
#define F_div_f_d2(c,z,y,x) scalar2
#define W_ave_f_d3(c,z,y,x) array4[(c)]
#define F_bar_f_d3(c,z,y,x) array3[offset4((c),(z),(y)+3,(x)+3,(N+1),(N+2+3+1),(N+2+3+1))&32767]
#define W_f_d3(c,z,y,x) array5[(c)]
#define F_ave_f_d3(c,z,y,x) array1[offset4((c),(z),(y)+2,(x)+2,(N+1),(N+1+2+1),(N+1+2+1))&8191]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double* array3 = (double*) malloc(32768*sizeof(double));    // 1866240
    double* array5 = (double*) malloc(5*sizeof(double));
    double* array4 = (double*) malloc(16384*sizeof(double));    // 1715000
    double scalar0;
    double retval;
    double* array1 = (double*) malloc(8192*sizeof(double));  // 1502800
    double* array11 = (double*) malloc(16384*sizeof(double));   // 1617000
    double* array10 = (double*) malloc(16384*sizeof(double));
    double scalar2;
    double* array9 = (double*) malloc(16384*sizeof(double));
    double* array8 = (double*) malloc(16384*sizeof(double));
    double* array7 = (double*) malloc(16384*sizeof(double));
    double* array6 = (double*) malloc(16384*sizeof(double));

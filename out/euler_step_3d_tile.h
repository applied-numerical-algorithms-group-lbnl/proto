// 'euler_step' code generated by 'edavis' at 07/18/2019 13:30:19
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
#define W_ave(c,z,y,x) W_ave[offset3((z)+3,(y)+3,(x)+3,(N+2+3+1),(N+2+3+1))&65535]
...
#define W_ave_f_d1(c,z,y,x) W_ave_f_d1[offset4((c),(z)+3,(y)+3,(x),(N+2+3+1),(N+2+3+1),(N+1))&524287]
...
#define W_ave_f_d2(c,z,y,x) W_ave_f_d2[offset4((c),(z)+3,(y),(x)+3,(N+2+3+1),(N+1),(N+2+3+1))&524287]
...
#define W_ave_f_d3(c,z,y,x) W_ave_f_d3[(c)]
...
inline double euler_step(const double* U, double* rhs) {
    ...
    double umax;
    double retval;
    double* W_ave = (double*) malloc(65536*sizeof(double));
    ...
    double* W_ave_f_d1 = (double*) malloc(524288*sizeof(double));
    ...
    double* W_ave_f_d2 = (double*) malloc(524288*sizeof(double));
    ...
    double* W_ave_f_d3 = (double*) malloc((C)*sizeof(double));

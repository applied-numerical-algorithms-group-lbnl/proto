// 'euler_step' code generated by 'edavis' at 07/15/2019 17:47:28
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
for(t2 = -1; t2 <= 8; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = max(8*t2,-4); t8 <= min(8*t2+7,67); t8++) {
        for(t10 = max(8*t4,-4); t10 <= min(8*t4+7,67); t10++) {
          for(t12 = max(-4,8*t6); t12 <= min(67,8*t6+7); t12++) {
            s0(t8,t10,t12);
            if (t8 <= 66 && t12 <= 66 && t10 <= 66) {
              if (t12 >= -3 && t10 >= -3 && t8 >= -3) {
                for(t14 = 0; t14 <= 4; t14++) {
                  s1(t14,t8,t10,t12);
                }
              ...
              if (t8 <= 63 && t2 >= 0 && t6 >= 0 && t4 >= 0 && t10 <= 63 && t12 <= 63) {
                s3(t8,t10,t12);
                s4(t8,t10,t12);
              }
            }
...
for(t2 = 0; t2 <= 4; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = -1; t8 <= 8; t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(66,8*t4+7); t10++) {
          for(t12 = max(-3,8*t6); t12 <= min(66,8*t6+7); t12++) {
            for(t14 = max(5*t8,-3); t14 <= min(0,8*t8+7); t14++) {
              s0(t2,t10,t12,t14);
              s1(t2,t10,t12,t14);
            }
            for(t14 = max(1,8*t8); t14 <= min(8*t8+7,66); t14++) {
              s0(t2,t10,t12,t14);
              s1(t2,t10,t12,t14);
              s2(t2,t10,t12,t14-1);
              s3(t2,t10,t12,t14-2);
            ...
            if (t12 >= 1) {
              for(t14 = max(-3,8*t8); t14 <= min(8*t8+7,66); t14++) {
                s4(t2,t10,t12-1,t14);
                s5(t2,t10,t12-2,t14);
              }
            }
          ...
          if (t10 >= 1) {
            for(t12 = max(8*t6,-3); t12 <= min(8*t6+7,66); t12++) {
              for(t14 = max(8*t8,-3); t14 <= min(8*t8+7,66); t14++) {
                s6(t2,t10-1,t12,t14);
                s7(t2,t10-2,t12,t14);
              }
            }
...
for(t2 = -1; t2 <= 8; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = 0; t6 <= 8; t6++) {
      for(t8 = max(8*t2,-3); t8 <= min(8*t2+7,66); t8++) {
        for(t10 = max(8*t4,-3); t10 <= min(8*t4+7,66); t10++) {
          for(t12 = 8*t6; t12 <= min(64,8*t6+7); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= 4; t14++) {
              s2(t14,t8,t10,t12);
...
for(t2 = -1; t2 <= 8; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = 0; t6 <= 8; t6++) {
      for(t8 = max(8*t2,-2); t8 <= min(8*t2+7,65); t8++) {
        for(t10 = max(8*t4,-2); t10 <= min(8*t4+7,65); t10++) {
          for(t12 = 8*t6; t12 <= min(64,8*t6+7); t12++) {
            for(t14 = 0; t14 <= 4; t14++) {
              s0(t14,t8,t10,t12);
            }
...
for(t2 = 0; t2 <= 4; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = 0; t8 <= 8; t8++) {
        for(t10 = max(-2,8*t4); t10 <= min(65,8*t4+7); t10++) {
          for(t12 = max(-2,8*t6); t12 <= min(65,8*t6+7); t12++) {
            if (t8 <= 0) {
              s0(t2,t10,t12,0);
              s1(t2,t10,t12,0);
            }
            if (t4 == -1) {
              for(t14 = max(8*t8,1); t14 <= min(8*t8+7,64); t14++) {
                s0(t2,t10,t12,t14);
                s1(t2,t10,t12,t14);
                s2(t2,t10,t12,t14-1);
              }
...
for(t2 = -1; t2 <= 8; t2++) {
  for(t4 = 0; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = max(8*t2,-3); t8 <= min(8*t2+7,66); t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,64); t10++) {
          for(t12 = max(-3,8*t6); t12 <= min(66,8*t6+7); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= 4; t14++) {
...
for(t2 = -1; t2 <= 8; t2++) {
  for(t4 = 0; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = max(8*t2,-2); t8 <= min(8*t2+7,65); t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,t4+56); t10++) {
          for(t12 = max(-2,8*t6); t12 <= min(65,8*t6+7); t12++) {
            for(t14 = 0; t14 <= 4; t14++) {
              s0(t14,t8,t10,t12);
            }
  ...
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = 0; t6 <= 8; t6++) {
      for(t8 = -1; t8 <= 8; t8++) {
        for(t10 = max(-2,8*t4); t10 <= min(65,8*t4+7); t10++) {
          for(t12 = 8*t6; t12 <= min(64,8*t6+7); t12++) {
            for(t14 = max(8*t8,-2); t14 <= min(8*t8+7,65); t14++) {
              s0(t2,t10,t12,t14);
              s1(t2,t10,t12,t14);
            }
            if (t12 >= 1) {
              ...
              if (t4 == -1) {
                for(t14 = max(0,8*t8); t14 <= min(63,8*t8+7); t14++) {
                  s2(t2,t10,t12-1,t14);
                }
              }
              if (t10 <= 63) {
                if (t10 >= 0) {
                  for(t14 = max(0,8*t8); t14 <= 8*t8+7; t14++) {
                    if (t14 <= 63) {
                      s2(t2,t10,t12-1,t14);
                      s3(t2,t10,t12-1,t14);
                    }
                ...
                if (t8 >= 8) {
                  for(t14 = 64; t14 <= 65; t14++) {
                    s2(t2,t10,t12-1,t14);
                  }
                }
              }
              if (t4 == 8) {
                for(t14 = max(-2,8*t8); t14 <= min(65,8*t8+7); t14++) {
                  s2(t2,t10,t12-1,t14);
                }
              }
            }
...
for(t2 = 0; t2 <= 8; t2++) {
  for(t4 = -1; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = 8*t2; t8 <= min(t2+56,8*t2+7); t8++) {
        for(t10 = max(-3,8*t4); t10 <= min(8*t4+7,66); t10++) {
          for(t12 = max(-3,8*t6); t12 <= min(66,8*t6+7); t12++) {
            s0(t8,t10,t12);
            s1(t8,t10,t12);
            for(t14 = 0; t14 <= 4; t14++) {
...
for(t2 = 0; t2 <= 4; t2++) {
  for(t4 = 0; t4 <= 8; t4++) {
    for(t6 = -1; t6 <= 8; t6++) {
      for(t8 = -1; t8 <= 8; t8++) {
        for(t10 = 8*t4; t10 <= min(8*t4+7,t4+56); t10++) {
          for(t12 = max(8*t6,-2); t12 <= min(65,8*t6+7); t12++) {
            if (t10 <= 63) {
              for(t14 = max(-2,8*t8); t14 <= min(65,8*t8+7); t14++) {
                s0(t2,t10,t12,t14);
                s1(t2,t10,t12,t14);
          ...
          if (t6 >= 0 && t8 >= 0 && t10 >= 1 && t8 <= 7) {
            for(t12 = 8*t6; t12 <= min(63,8*t6+7); t12++) {
              for(t14 = 8*t8; t14 <= 8*t8+7; t14++) {
                s3(t2,t10-1,t12,t14);
                s4(t2,t10-1,t12,t14);
              }
            }

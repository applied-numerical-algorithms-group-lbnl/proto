...
BoxData<T,1,1,1> slice(const BoxData< T,C,D,E> & a_src, 
                       ...
                       unsigned int a_e = 0)
\end{verbatim}
creates a scalar-valued \code{BoxData} that points to the slice corresponding to compoenent \code{(a\_c,a\_d,a\_e)}. The resulting \code{BoxData} can then be used in functions taking scalar-valued \code{BoxData}s. Similarly, the function 
\begin{verbatim}
